...
try:
    ...
    from subdomainrecon import discovery_subdomain_target
...
class Scraping:
    ...
    def get_documentation(self):
        ...
        parser = argparse.ArgumentParser(
            prog='alsha',
            description='Detailed web browsing and Enumeration',
        )

        print("""
_____________      ____________         
___    |__  /__________  /__  /_______ _
...
AUTHOR:Hunkar Acar 
Program:Als|ha
Program Purpose: Web scraping and Enumeration
        ...
        parser.add_argument('-Subd','--subdirectory',type=str,help='Detects the subdomains used by the site(The software uses its own wordlist) / parameter => example.com ')
        parser.add_argument('--protocol', type=str, choices=['http', 'https'], default='http',help='Specify the protocol (http or https) For subdomain discovery')
    ...
    def discovery_subdomain(self,target_domain,protocol):

        try:
            discovery_subdomain_target(target_domain,protocol)
...
if __name__ == "__main__":
    ...
    try:
        ...
        if args.subdirectory:
            scraping.discovery_subdomain(args.subdirectory,args.protocol)
